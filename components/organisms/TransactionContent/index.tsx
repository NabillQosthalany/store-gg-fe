                    ...
                    <div className="main-content main-content-table overflow-auto">
                        <table className="table table-borderless">
                            ...
                            <tbody id="list_status_item">
                                ...
                                <TableRow image="overview-2" title="Call of Duty:Modern" category="Desktop" item={200} price={290000} status="Success" />
                                <TableRow image="overview-3" title="Clash of Clans" category="Mobile" item={200} price={290000} status="Failed" />
                                <TableRow image="overview-4" title="The Royal Game" category="Mobile" item={200} price={290000} status="Success" />
                            </tbody>
                        </table>
                    </div>
                </div>
